Shader "Astra/Glitter Gradient"
{
 ...
 fixed4 frag(v2f i):SV_Target {
  ...
  float pulse=lerp(1,0.55+0.45*pow(0.5+0.5*sin(_Time.y*0.45+dot(i.world,float3(2.1,1.7,3.3))),2),_Twinkle);
  ...
  return fixed4(color*_Brightness*i.color.rgb,mask*i.color.a*pulse*nearFade);
 }
 ENDCG
 }
 }
